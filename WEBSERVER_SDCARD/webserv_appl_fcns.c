...
extern uint32_t ui32User0, ui32User1;   //MAC address
...
void InitTimer0Int(void)
{
    ...
    ui32_Period = (g_ui32SysClock/100);                       //120MHz/100 => 1.2Mticks -> Period of 0.01s

    TimerLoadSet(TIMER0_BASE, TIMER_A, ui32_Period - 1);     //-1 wegen null-count
